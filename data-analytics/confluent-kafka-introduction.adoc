...
NetApp instaclustr 從 3.8.1 版本開始也支援 Kafka 分層儲存。請點擊此處查看更多詳情 link:https://www.instaclustr.com/support/documentation/kafka-add-ons/using-kafka-tiered-storage/["使用 Kafka 分層儲存的 Instaclust"]
